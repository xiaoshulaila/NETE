...
|---:|---:|---:|---:|---:|---:|
| 0 | 100 | 1 | 35 | 0 | 3000 |
| 1 | 100 | 3 | 35 | 12000 | 2000 |
| 2 | 300 | 3 | 35 | 12000 | 2000 |
| 3 | 500 | 2 | 35 | 12500 | 2000 |
| 4 | 1000 | 1 | 40 | 13000 | 2000 |
| 5 | 3000 | 1 | 40 | 13500 | 2000 |
| 6 | 5000 | 1 | 40 | 13500 | 2000 |
| 7 | 10000 | 1 | 50 | 14000 | 2000 |
| 8 | 30000 | 1 | 50 | 14000 | 2000 |
...
- 对**付费矿机（isAirdrop=false）**，提现时按仓位档位配置扣手续费：`fee = amount * tierConfigs[tierIndex].feeBps / 10000`。
- 当前默认配置下，付费档位（`tier 1..9`）`feeBps=2000`，即统一 `20%`。
- 对空投矿机维持原口径：提现不扣该 20% 矿机手续费。
...
- 若使用升级脚本，可设置环境变量：
  ...
  脚本会在升级后批量把 `tier 1..9` 的 `feeBps` 调整为目标值。
